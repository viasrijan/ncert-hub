    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col items-center gap-8 px-6 py-12 md:px-8 md:py-16">
      <div className="flex flex-col items-center gap-6 text-center animate-fade-in-up">
        ...
        <a
          ...
          className="inline-flex items-center gap-2.5 rounded-lg bg-gradient-to-r from-red-600 to-pink-600 px-8 py-3.5 text-lg font-bold text-white shadow-elevated transition-opacity hover:opacity-90"
        >
