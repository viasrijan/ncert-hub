  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-6 py-12 md:px-8 md:py-16">
      <div className="flex flex-col items-center text-center gap-2 animate-fade-in-up">
        <h1 className="font-display text-5xl font-bold tracking-tight md:text-6xl text-foreground">Solutions by Class</h1>
        <p className="text-lg text-muted-foreground">Pick a class to see every book available for it.</p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col min-w-0 flex-1">
                <h2 className="font-display text-xl font-bold text-foreground">Class {toRoman(c)} - Solutions</h2>
