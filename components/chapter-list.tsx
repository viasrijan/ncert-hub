        ...
        {book.chapters.map((chapter) => (
          <li key={chapter.pdfCode} className="flex items-stretch">
            <Link
              ...
              className="flex min-w-0 flex-1 items-center gap-3 px-4 py-3.5 transition-colors duration-150 hover:bg-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring"
            >
              ...
              <span className="min-w-0 truncate text-base font-semibold text-card-foreground">
                {chapter.title}
              </span>
            </Link>
            <a
