  ...
  return (
    <div className="flex min-h-svh">
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-y-auto h-svh">
        ...
        <footer className="hidden flex-col items-center gap-5 px-8 pt-8 pb-12 lg:flex">
          ...
          <nav aria-label="Legal" className="flex items-center gap-5 text-xs font-semibold text-muted-foreground">
            <Link href="/guides" className="hover:text-foreground">Guides</Link>
            <Link href="/about" className="hover:text-foreground">About</Link>
            <Link href="/privacy" className="hover:text-foreground">Privacy</Link>
            <Link href="/terms" className="hover:text-foreground">Terms</Link>
