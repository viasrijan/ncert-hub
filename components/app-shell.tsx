      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-y-auto h-svh">
        ...
        <footer className="hidden px-8 py-6 lg:flex lg:flex-col lg:items-center lg:justify-center lg:gap-4">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-md bg-gradient-to-r from-red-600 to-pink-600 px-4 py-2 text-sm font-bold text-white transition-opacity hover:opacity-90"
          >
            Donate
